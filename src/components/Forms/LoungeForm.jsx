...
const LoungeForm = () => {
  ...
  return(
    <div>
      <h2 className="text-center mt-3">Lounge form</h2>
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="loungeFormName">
          ...
          <Form.Group as={Col} md="4" controlId="loungeFormCarpetArea">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="loungeFormCeilingHeight">
          ...
          <Form.Group as={Col} md="4" controlId="loungeFormAddPhoto">
          ...
          <Form.Group as={Col} md="4" controlId="loungeFormAmbiance">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="loungeFormFacilitiesProvided">
          ...
          <Form.Group as={Col} md="4" controlId="loungeFormCrockery">
          ...
          <Form.Group as={Col} md="4" controlId="loungeFormAC">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="loungeFormRemarks">
