...
const StoreForm = () => {
  ...
  return (
    <div>
      <h2 className="text-center mt-3">Store Form</h2>
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="storFormName">
          ...
          <Form.Group as={Col} md="4" controlId="storeFormCarpetArea">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="storeFormCeilingHeight">
          ...
          <Form.Group as={Col} md="4" controlId="storeFormAddPhoto">
          ...
          <Form.Group as={Col} md="4" controlId="storeFormAmbiance">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="storeFormFacilitiesProvided">
          ...
          <Form.Group as={Col} md="4" controlId="storeFormCrockery">
          ...
          <Form.Group as={Col} md="4" controlId="storeFormAC">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="storeFormRemarks">
