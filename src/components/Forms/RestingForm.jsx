...
const RestingForm = () => {
  ...
  return (
    <div>
      <h2 className="text-center mt-3">Resting Area Form</h2>
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="restingFormName">
          ...
          <Form.Group as={Col} md="4" controlId="restingFormCarpetArea">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="restingFormCeilingHeight">
          ...
          <Form.Group as={Col} md="4" controlId="restingFormAddPhoto">
          ...
          <Form.Group as={Col} md="4" controlId="restingFormAmbiance">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="restingFormFacilitiesProvided">
          ...
          <Form.Group as={Col} md="4" controlId="restingFormCrockery">
          ...
          <Form.Group as={Col} md="4" controlId="restingFormAC">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="restingFormRemarks">
