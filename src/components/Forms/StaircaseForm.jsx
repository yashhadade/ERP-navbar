...
const StaircaseForm = () => {
  ...
  return  (
    <div>
      <h2 className="text-center mt-3">Staiircase Form</h2>
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="staircaseFormName">
          ...
          <Form.Group as={Col} md="4" controlId="staircaseFormCarpetArea">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="staircaseFormCeilingHeight">
          ...
          <Form.Group as={Col} md="4" controlId="staircaseFormAddPhoto">
          ...
          <Form.Group as={Col} md="4" controlId="staircaseFormAmbiance">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="staircaseFormFacilitiesProvided">
          ...
          <Form.Group as={Col} md="4" controlId="staircaseFormCrockery">
          ...
          <Form.Group as={Col} md="4" controlId="staircaseFormAC">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="staircaseFormRemarks">
