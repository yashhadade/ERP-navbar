...
const ManagerForm = () => {
  ...
  return (
    <div>
      <h2 className="text-center mt-3">Manager office form</h2>
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="managerFormName">
          ...
          <Form.Group as={Col} md="4" controlId="managerFormCarpetArea">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="managerFormCeilingHeight">
          ...
          <Form.Group as={Col} md="4" controlId="managerFormAddPhoto">
          ...
          <Form.Group as={Col} md="4" controlId="managerFormAmbiance">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="managerFormFacilitiesProvided">
          ...
          <Form.Group as={Col} md="4" controlId="managerFormCrockery">
          ...
          <Form.Group as={Col} md="4" controlId="managerFormAC">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="managerFormRemarks">
